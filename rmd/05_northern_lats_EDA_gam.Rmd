...
mean_18deg_lat_by_year_diff_sept_mar %>%
ggplot() +    
    geom_line(aes(x=year, y=y), fill = "steelblue", colour = "steelblue", alpha = 0.9, lwd =2) +
    geom_point(aes(x=year, y=y), fill = "steelblue", colour = "steelblue", alpha = 0.6, size=3) + 

    scale_x_continuous(breaks=seq(1998,2023,2)) + 
    labs(x='Year', y = 'Difference (°Latitude)')
```
