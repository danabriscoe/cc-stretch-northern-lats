...
gam_18degC_lat_year_output_diff_sept_mar <- run_gam_kfolds(data=mean_18deg_lat_by_year_diff_sept_mar, kfolds = 5, mon = "Sept-Mar")
...
mean_18deg_lat_by_year_diff_sept_mar %>%
ggplot() +    
geom_point(aes(x=year, y=y), fill = "steelblue", colour = "navy", alpha = 0.6) + 
geom_line(aes(x=year, y=y), fill = "steelblue", colour = "navy", alpha = 0.6) +
