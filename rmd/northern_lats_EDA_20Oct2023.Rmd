...
For each figure, the darker line represents the average isotherm location location between 1997-2022). The lighter line represents the 2023 isotherm location.
