...
```{r 06-hist-daily-hist-cohort1-sept-by-sst-bins}
br <- seq(15,25,0.5)

p_hist_septs_daily_sst <- 
...
ggsave(filename = str_c('hist_sept_turtle_days_sst_1997_2012_all_years.png'), plot = p_hist_septs_daily_sst, 
       # height=9,
       width=10, bg='white',
       path = '../figs/'
       )
...
p_hist_avg_sept_sst_2006_2007 <- obsdata_165W_mar_septs %>%
    filter(month == 9) %>%
    filter(year != 2023) %>%
...
# ## Plot
# br <- seq(17,22,0.5)
# hist(avg_sept_sst_2006_2007$avg[avg_sept_sst_2006_2007$yr_cat==0],xlim=c(17,22),col='skyblue',border=F, breaks=br,
#           main="September Turtle Days by SST (°C): 1997-2012",
#      xlab="SST (°C)")
# hist(avg_sept_sst_2006_2007$avg[avg_sept_sst_2006_2007$yr_cat==1],xlim=c(17,22), col=scales::alpha('red',.5),border=F,
#      breaks=br,
#      add=T
#      )
# 
# legend("topright", c("1997-2012 (!=2006-07)", "2006-2007"), col=c("skyblue", scales::alpha('red',.5)), lwd=10, bty='n')

## Save
# dev.copy(png,"../figs/hist_sept_turtle_days_sst_2006_2007_subset.png",width=10,height=8,units="in",res=100)
# dev.off()

ggsave(filename = str_c('hist_sept_turtle_days_sst_2006_2007_subset.png'), plot = p_hist_avg_sept_sst_2006_2007, 
       # height=9,
       width=10, bg='white',
       path = '../figs/'
       )
...
# dev.off()
ggsave(filename = str_c('hist_mar_turtle_days_sst_2006_2007_subset.png'), plot = p_hist_avg_mar_sst_2006_2007, 
       # height=9,
       width=10, bg='white',
       path = '../figs/'
       )
